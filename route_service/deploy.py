...
def deploy_to_ecs(ecr_uri, sg_id):
    ...
    eni_id = [
        details["value"]
        for details in task_details["tasks"][0]["attachments"][0]["details"]
    ...
    print(
        f"API de Rotas Online. IP Público: http://{public_ip}:8001/rotas/health"
    )
...
if __name__ == "__main__":
    ...
    print(
        f"Deploy finalizado com sucesso. Acesse: http://{public_ip}:8001/rotas/health"
    )
